...
class streams_vectors(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "stream", catch_exceptions=True)
        ...
        self.settings = Qt.QSettings("GNU Radio", "streams_vectors")
        ...
        self.qtgui_time_sink_x_1_0 = qtgui.time_sink_c(
            1024, #size
            samp_rate, #samp_rate
            "Signal Source B before Convertion", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.qtgui_time_sink_x_1 = qtgui.time_sink_c(
            1024, #size
            samp_rate, #samp_rate
            "Signal Source B after Convertion", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.qtgui_time_sink_x_0_0 = qtgui.time_sink_c(
            1024, #size
            samp_rate, #samp_rate
            "Signal Source A before Convertion", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.qtgui_time_sink_x_0 = qtgui.time_sink_c(
            1024, #size
            samp_rate, #samp_rate
            "Signal Source A after Convertion", #name
            1, #number of inputs
            None # parent
        )
        ...
        self.analog_sig_source_x_1 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 100, 0.1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_1, 0), (self.qtgui_time_sink_x_1_0, 0))
        ...
        self.connect((self.blocks_vector_to_stream_0, 0), (self.qtgui_time_sink_x_2, 0))
...
def main(top_block_cls=streams_vectors, options=None):
