...
class sine_wave_flowgraph(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "first_tutorial", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("first_tutorial")
        ...
        self.settings = Qt.QSettings("GNU Radio", "sine_wave_flowgraph")
...
def main(top_block_cls=sine_wave_flowgraph, options=None):
