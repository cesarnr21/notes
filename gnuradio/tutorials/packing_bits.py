...
class packing_bits(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "packing_bits_tutorial", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("packing_bits_tutorial")
        ...
        self.settings = Qt.QSettings("GNU Radio", "packing_bits")
        ...
        self.qtgui_histogram_sink_x_1.enable_autoscale(True)
        self.qtgui_histogram_sink_x_1.enable_accumulate(False)
        ...
        self._qtgui_histogram_sink_x_1_win = sip.wrapinstance(self.qtgui_histogram_sink_x_1.qwidget(), Qt.QWidget)
        self.top_layout.addWidget(self._qtgui_histogram_sink_x_1_win)
        ...
        self.connect((self.blocks_char_to_float_1, 0), (self.qtgui_histogram_sink_x_1, 0))
...
def main(top_block_cls=packing_bits, options=None):
